...
user_pref("extensions.allowPrivateBrowsingByDefault", true); // Allows extensions to be used in private mode by default
user_pref("browser.ctrlTab.recentlyUsedOrder", false); // Ctrl+Tab will cycle tabs in the most recently used order
user_pref("media.videocontrols.picture-in-picture.enabled", false); // Enable or disable picture-in-picture mode button when playing video media
...
user_pref("media.autoplay.allow-extension-background-pages", false); // Allows background scripts from add-ons to autoplay audio media
user_pref("media.autoplay.block-event.enabled", true); // Blocks further autoplay events
